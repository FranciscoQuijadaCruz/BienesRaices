...
$search = "%".mysql_real_escape_string(trim($_GET['userSearch']))."%";
// Obtenemos todos los usuarios de la base de datos
$queryGetUsers = "SELECT id, nombre, apellidos, email FROM tblUsuarios WHERE nombre LIKE '$search' OR apellidos LIKE '$search'";
...
<div id="content" class="txt_content">
  ...
  <?php
  if($totalUsers == 0){
    echo '<p class="announce">The search query didn\'t match any user.<p>';
  }
  else{ ?>
