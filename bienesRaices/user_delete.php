...
if(isset($_POST['sent'])) {
  ...
  $queryUserDelete = sprintf("DELETE FROM tblUsuarios WHERE id = %d",
    $_POST['id']
  );
  ...
  if($resQueryUserDelete) {
    header("Location: user_admin.php?deletedUser=true");
  }
}
...
<div id="content" class="txt_content">
  <h2>User delete</h2>
  <p class="announce">This action can't be undone, are you sure you want to delete this user?</p>

  <form action="user_delete.php?userId=<?php echo $userDetails['id'];?>" method="post">
  	<table>
  		<tr>
      ...
      <tr>
        ...
        <td>
  		...
  		<tr>
  			...
  			<td><br /><input type="submit" value="DELETE USER X(" name="sent" /></td>
  		</tr>
  	</table>
  </form>
